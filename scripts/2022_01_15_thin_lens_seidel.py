...
surfaces = [
    ...
    rt.flat_surface([0, 0, lens_start + t], [0, 0, 1], aperture_radius, is_aperture_stop=True),
    rt.spherical_surface.get_on_axis(r1, lens_start, aperture_radius),
    rt.spherical_surface.get_on_axis(r2, lens_start, aperture_radius),
    ]
